				...
				<table class="table">
					...
					<tbody>
						...
						echo "<tr>";
							...
							echo "<td><a href=\"edit_usuario.php?id=$res[id]\"><button>Editar</button></a> | <a href=\"delete_usuario.php?id=$res[id]\" onClick=\"return confirm('Quer mesmo deletar o Usuário?')\"><button>Deletar</button></a></td>";
						echo "</tr>"; 
						}
						?>             
					</tbody>
				...
				<table class="table">
					...
					<?php
						...
						echo "<tr>";
							...
							echo "<td><a href=\"edit_produto.php?id=$res[id]\"><button>Editar</button></a> | <a href=\"delete_produto.php?id=$res[id]\" onClick=\"return confirm('Quer mesmo deletar o Produto?')\"><button>Deletar</button></a></td>";
						echo "</tr>"; 
						}
						?>             
					</tbody>
